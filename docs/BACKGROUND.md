...
- **Plugin:** **Render kaeriten** (manual) builds inline images/frames for print; running **Render** again rebuilds stale views; **Copy plain** reads canonical Unicode from source + `mapping.json`, not from hidden metadata or object pixels.
